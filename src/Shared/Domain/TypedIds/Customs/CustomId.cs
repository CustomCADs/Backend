...
namespace CustomCADs.Shared.Domain.TypedIds.Customs;

public readonly struct CustomId : IEntityId<Guid>
{
	...
	public static CustomId New(string id) => new(Guid.Parse(id));
	public static Guid Unwrap(CustomId id) => id.Value;
	public static Guid? Unwrap(CustomId? id) => id?.Value;
