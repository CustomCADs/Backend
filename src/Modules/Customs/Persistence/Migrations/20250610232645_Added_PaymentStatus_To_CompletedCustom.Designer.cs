...
namespace CustomCADs.Modules.Customs.Persistence.Migrations
{
    ...
    [Migration("20250610232645_Added_PaymentStatus_To_CompletedCustom")]
    partial class Added_PaymentStatus_To_CompletedCustom
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomCADs.Modules.Customs.Domain.Customs.Entities.AcceptedCustom", b =>
                {
            ...
            modelBuilder.Entity("CustomCADs.Modules.Customs.Domain.Customs.Entities.CompletedCustom", b =>
                {
                    b.Property<Guid>("CustomId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Customs.Domain.Customs.Entities.FinishedCustom", b =>
                {
                    b.Property<Guid>("CustomId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Customs.Domain.Customs.Entities.AcceptedCustom", b =>
                {
                    b.HasOne("CustomCADs.Modules.Customs.Domain.Customs.Custom", null)
                        ...
                        .HasForeignKey("CustomCADs.Modules.Customs.Domain.Customs.Entities.AcceptedCustom", "CustomId")
            ...
            modelBuilder.Entity("CustomCADs.Modules.Customs.Domain.Customs.Entities.CompletedCustom", b =>
                {
                    b.HasOne("CustomCADs.Modules.Customs.Domain.Customs.Custom", null)
                        ...
                        .HasForeignKey("CustomCADs.Modules.Customs.Domain.Customs.Entities.CompletedCustom", "CustomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CustomCADs.Modules.Customs.Domain.Customs.Entities.FinishedCustom", b =>
                {
                    b.HasOne("CustomCADs.Modules.Customs.Domain.Customs.Custom", null)
                        ...
                        .HasForeignKey("CustomCADs.Modules.Customs.Domain.Customs.Entities.FinishedCustom", "CustomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
