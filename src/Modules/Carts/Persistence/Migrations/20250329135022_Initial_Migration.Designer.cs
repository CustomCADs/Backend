...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomCADs.Modules.Carts.Domain.ActiveCarts.ActiveCart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Carts.Domain.ActiveCarts.Entities.ActiveCartItem", b =>
                {
            ...
            modelBuilder.Entity("CustomCADs.Modules.Carts.Domain.PurchasedCarts.Entities.PurchasedCartItem", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid")
                        .HasColumnName("ProductId");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Carts.Domain.PurchasedCarts.PurchasedCart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Carts.Domain.ActiveCarts.Entities.ActiveCartItem", b =>
                {
                    b.HasOne("CustomCADs.Modules.Carts.Domain.ActiveCarts.ActiveCart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("CustomCADs.Modules.Carts.Domain.PurchasedCarts.Entities.PurchasedCartItem", b =>
                {
                    b.HasOne("CustomCADs.Modules.Carts.Domain.PurchasedCarts.PurchasedCart", "Cart")
                        .WithMany("Items")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
