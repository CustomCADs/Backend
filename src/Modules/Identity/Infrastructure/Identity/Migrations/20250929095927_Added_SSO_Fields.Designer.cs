...
namespace CustomCADs.Identity.Infrastructure.Identity.Migrations
{
    ...
    [Migration("20250929095927_Added_SSO_Fields")]
    partial class Added_SSO_Fields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomCADs.Identity.Infrastructure.Identity.ShadowEntities.AppRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Identity.Infrastructure.Identity.ShadowEntities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Identity.Infrastructure.Identity.ShadowEntities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Identity.Infrastructure.Identity.ShadowEntities.AppRefreshToken", b =>
                {
                    b.HasOne("CustomCADs.Identity.Infrastructure.Identity.ShadowEntities.AppUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("CustomCADs.Identity.Infrastructure.Identity.ShadowEntities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CustomCADs.Identity.Infrastructure.Identity.ShadowEntities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
