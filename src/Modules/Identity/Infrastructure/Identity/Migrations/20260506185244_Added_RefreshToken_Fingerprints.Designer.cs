...
namespace CustomCADs.Modules.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260506185244_Added_RefreshToken_Fingerprints")]
    partial class Added_RefreshToken_Fingerprints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Fingerprint", "CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppRefreshToken.Fingerprint#Fingerprint", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a8145f5f-a3a4-4f06-9461-9f24b9f23fde"),
                            AccessFailedCount = 0,
                            AccountId = new Guid("8d477999-0580-4770-8864-e9ba4bed9cd1"),
                            ConcurrencyStamp = "c5940d6f-d5c0-4f84-a262-da9b07525c3c",
                            Email = "john.cad@gmail.com",
                            EmailConfirmed = true,
                            IsSSO = false,
                            LockoutEnabled = true,
                            NormalizedEmail = "JOHN.CAD@GMAIL.COM",
                            NormalizedUserName = "JOHN_CAD",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c11d44ef-29c5-43ac-89f9-a2e7cd482ec8",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJGRCbKUsSh9BwxPXoIQRG1AVXYDfmWsY5vEA4aEnqBBQAzdcgLFCHUtpwd86+B4mA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "MHG763AUJVOJPKKWUC64FQSF7DIVVBOU",
                            TwoFactorEnabled = false,
                            UserName = "Oracle3000"
                        },
                        new
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            UserId = new Guid("a8145f5f-a3a4-4f06-9461-9f24b9f23fde"),
            ...
            modelBuilder.Entity("CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppRefreshToken", b =>
                {
                    b.HasOne("CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CustomCADs.Modules.Identity.Infrastructure.Identity.ShadowEntities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
