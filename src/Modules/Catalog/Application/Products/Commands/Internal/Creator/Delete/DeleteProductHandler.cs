...
) : ICommandHandler<DeleteProductCommand>
{
	public async Task Handle(DeleteProductCommand req, CancellationToken ct)
	{
		...
		await raiser.RaiseApplicationEventAsync(
			@event: new ProductDeletedApplicationEvent(
				Id: product.Id,
		...
		await raiser.RaiseApplicationEventAsync(
			@event: new NotificationRequestedEvent(
				...
				Description: ApplicationConstants.Notifications.Messages.ProductDeleted,
				Link: ApplicationConstants.Notifications.Links.ProductDeleted,
