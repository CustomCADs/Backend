...
{
	extension(EntityTypeBuilder<Category> builder)
	{
		internal EntityTypeBuilder<Category> SetPrimaryKey()
		{
		...
		internal EntityTypeBuilder<Category> SetStronglyTypedIds()
		{
		...
		internal EntityTypeBuilder<Category> SetValidations()
		{
		...
		internal EntityTypeBuilder<Category> SetSeedData()
		{
			builder.HasData([
