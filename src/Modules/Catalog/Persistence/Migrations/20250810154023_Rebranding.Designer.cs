...
namespace CustomCADs.Modules.Catalog.Persistence.Migrations
{
    ...
    [Migration("20250810154023_Rebranding")]
    partial class Rebranding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomCADs.Modules.Catalog.Domain.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CustomCADs.Modules.Catalog.Domain.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Catalog.Domain.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CustomCADs.Modules.Catalog.Persistence.ShadowEntities.ProductTag", b =>
                {
            ...
            modelBuilder.Entity("CustomCADs.Modules.Catalog.Domain.Products.Product", b =>
                {
                    b.OwnsOne("CustomCADs.Modules.Catalog.Domain.Products.ValueObjects.Counts", "Counts", b1 =>
                        {
            ...
            modelBuilder.Entity("CustomCADs.Modules.Catalog.Persistence.ShadowEntities.ProductTag", b =>
                {
                    b.HasOne("CustomCADs.Modules.Catalog.Domain.Products.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CustomCADs.Modules.Catalog.Domain.Tags.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
