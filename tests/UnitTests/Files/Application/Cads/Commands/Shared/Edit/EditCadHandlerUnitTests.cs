using CustomCADs.Files.Application.Cads.Commands.Shared.Edit;
using CustomCADs.Files.Domain.Repositories;
using CustomCADs.Files.Domain.Repositories.Reads;
using CustomCADs.Shared.Application.Exceptions;
using CustomCADs.Shared.Application.UseCases.Cads.Commands;

namespace CustomCADs.UnitTests.Files.Application.Cads.Commands.Shared.Edit;
...
public class EditCadHandlerUnitTests : CadsBaseUnitTests
{
	...
	{
		// Arrange
		EditCadCommand command = new(ValidId, ValidContentType, ValidVolume);
