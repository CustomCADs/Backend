...
public class OpenNotificationsHandlerUnitTests : NotificationsBaseUnitTests
{
	private readonly OpenNotificationHandler handler;
	private readonly Mock<INotificationReads> reads = new();
	private readonly Mock<IUnitOfWork> uow = new();

	public OpenNotificationsHandlerUnitTests()
	{
	...
	{
		// Arrange
		OpenNotificationCommand command = new(ValidId, ValidReceiverId);
